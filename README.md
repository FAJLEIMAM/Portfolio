# FAJLE IMAM — cybersecurity student Portfolio

A dark-themed personal portfolio for **FAJLE IMAM** — Computer Science undergraduate from CUTM.
...
|-|-|-|
|ResumeIQ|[resumeiq-Fajle.vercel.app](https://resumeiq-Fajle.vercel.app)|React, Gemini API, Vercel|
...
|Contact methods|`src/components/ContactSection.tsx` (`CONTACT\_METHODS` array)|
...
Designed \& built by **FAJLE IMAM** · [LinkedIn](https://www.linkedin.com/in/fajleimam1/) · [GitHub](https://github.com/FAJLEIMAM/FAJLE-IMAM)
