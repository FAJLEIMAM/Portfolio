...
const ABOUT_TEXT =
"Hello! I'm Fajle Imam, a Computer Science undergraduate passionate about cybersecurity, digital forensics, and cybercrime investigation. I enjoy building security-focused projects such as phishing detection, port scanners, and OSINT tools. I'm continuously learning ethical hacking, network security, and incident response while working toward becoming a professional cybersecurity engineer.";
const AboutSection = () => {
  return (
    <section
      id="about"
