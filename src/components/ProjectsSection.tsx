...
const PROJECTS: ProjectData[] = [
    {
      ...
      name: 'PhishGuard AI',
      liveUrl: 'https://phishguard-ai.up.railway.app/',
      col1Image1: '/phishguard1.png',
      col1Image2: '/phishguard2.png',
      col2Image: '/phishguard3.png',
    },
  {
    number: '02',
    category: 'Cybersecurity',
    name: 'Port Scanner',
    liveUrl: '#',
    col1Image1: '/port1.png',
    col1Image2: '/port2.png',
    col2Image: '/port3.png',
  },
  {
    number: '03',
    category: 'Networking Security',
    name: 'BT-Ducky Commander',
    liveUrl: '#',
    col1Image1: '/bt1.png',
    col1Image2: '/bt2.png',
    col2Image: '/bt3.png',
  },
  {
    number: '04',
    category: 'Internship',
    name: 'ISRO Cybersecurity Internship',
    liveUrl: '#',
    col1Image1: '/isro1.png',
    col1Image2: '/isro2.png',
    col2Image: '/isro3.png',
  },
];
