...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'fajleimam19@gmail.com',
    href: 'mailto:fajleimam19@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    value: '+91 9508257764',
    href: 'https://wa.me/919508257764',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'linkedin.com/in/fajleimam1',
    href: 'https://www.linkedin.com/in/fajleimam1/',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: 'github.com/FAJLEIMAM',
    href: 'https://github.com/FAJLEIMAM',
  },
];
  ...
  return (
    ...
    >
      ...
      <FadeIn delay={0.15} y={20}>
        ...
        >
          Have a cybersecurity project, internship opportunity, or collaboration? Feel free to connect with me.
        </p>
      </FadeIn>
      ...
      <FadeIn delay={0.4} y={20}>
        <div className="mx-auto mt-20 sm:mt-24 md:mt-28 flex max-w-5xl flex-col items-center gap-3 border-t border-[#D7E2EA]/10 pt-8 text-center sm:flex-row sm:justify-between">
          ...
          <span
            ...
            style={{ fontSize: 'clamp(0.7rem, 1.1vw, 0.9rem)' }}
          >
            Cybersecurity Portfolio • Securing the Digital Future
          </span>
        </div>
      </FadeIn>
    </section>
